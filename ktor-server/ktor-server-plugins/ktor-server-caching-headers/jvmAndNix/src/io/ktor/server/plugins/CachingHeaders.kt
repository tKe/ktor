 ...
 */
public class CachingHeadersConfiguration {
 ...
 * It invokes [CachingHeadersConfiguration.optionsProviders] for every response and use first non-null [CachingOptions]
 */
public val CachingHeaders: RouteScopedPlugin<CachingHeadersConfiguration, PluginInstance> = createRouteScopedPlugin(
    "Caching Headers",
    ::CachingHeadersConfiguration
) {
